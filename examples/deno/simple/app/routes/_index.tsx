      ...
      <div className="mt-8 w-full max-w-4xl overflow-x-auto">
        <table className="w-full border-collapse bg-gray-100 shadow-md rounded-lg">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            <tr key={'runtime'} className="hover:bg-gray-50">
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">runtime</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{data.runtime}</td>
            </tr>
